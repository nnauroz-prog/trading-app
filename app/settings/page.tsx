  ...
  return (
    <main className="mx-auto max-w-5xl space-y-6 p-4 md:space-y-6 md:p-6">
      ...
      <header className="space-y-1">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-white">Daten &amp; Backup</h1>
        <p className="max-w-2xl text-sm text-slate-400">
          Deine Daten liegen lokal in diesem Browser. Hier kannst du sie sichern und auf ein anderes Gerät übertragen.
        </p>
      </header>
