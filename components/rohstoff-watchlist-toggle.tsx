...
export function RohstoffWatchlistToggle({ symbol, name, currentPrice }: { symbol: string; name: string; currentPrice?: number }) {
  ...
  return (
    <button
      onClick={() => toggleRohstoffWatch(symbol, name, currentPrice)}
