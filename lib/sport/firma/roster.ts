...
const H2H_SPECIALIST: SportEmployee[] = [
  {
    id: 'h2h-1',
    name: 'Sigrid Achterberg',
    role: 'Direktvergleichs-Spezialistin · gräbt zu jedem Aufeinandertreffen die gesamte H2H-Historie aus dem Datenpool aus.',
    department: 'h2h_specialist'
  }
];
