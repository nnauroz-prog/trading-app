...
describe('computeSizing', () => {
  it('risks exactly max-risk-% of capital at stop', () => {
    const config = { accountSize: 10000, maxRiskPct: 1, currency: 'EUR' as const, riskLimits: DEFAULT_RISK_LIMITS };
  ...
  it('returns null when capital is zero', () => {
    const config = { accountSize: 0, maxRiskPct: 1, currency: 'EUR' as const, riskLimits: DEFAULT_RISK_LIMITS };
